...
# SECRET_KEY = 'django-insecure-+atyn$+fri$bmygh_+s9(mo409cpx%h$2w%wt$l04e&q1(2cb='
...
ALLOWED_HOSTS = ['asmare.pythonanywhere.com', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://asmare.pythonanywhere.com']
